...
function builder(options) {
  ...
  if (!options.network) {
    options.network = alterdot.Networks.defaultNetwork;
  }

  options.Block = options.Block || alterdot.Block;
  options.BlockHeader = options.BlockHeader || alterdot.BlockHeader;
  options.Transaction = options.Transaction || alterdot.Transaction;
  options.MerkleBlock = options.MerkleBlock || alterdot.MerkleBlock;
  options.MnListDiff = options.MnListDiff || alterdot.MnListDiff;
