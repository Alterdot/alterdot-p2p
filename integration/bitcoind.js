...
var Random = alterdot.crypto.Random;
...
// These tests require a running alterdotd instance
describe('Integration with ' + network.name + ' alterdotd', function() {
